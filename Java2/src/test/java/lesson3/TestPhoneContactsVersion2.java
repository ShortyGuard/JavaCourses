 ...
 *
 * {@link PhoneContactsVersion2}
 */
public class TestPhoneContactsVersion2 {

    private PhoneContactsVersion2 phoneContacts;

    @Before
    public void before(){
        phoneContacts = new PhoneContactsVersion2();
